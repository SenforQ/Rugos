...
/*: "offmarket_loop_ :*/
fileprivate let controllerTunGroupSecret:[Character] = ["o","f","f","m","a","r"]
fileprivate let user_cornerUpFormat:String = "application calendar protection labelket_"
fileprivate let serviceBounceFlag:String = "loop_full decision index powder"
...
public class BindingCharacter: NSObject {
    
    //: public static let shared = LocalPushScheduler()
    public static let shared = BindingCharacter()
    ...
    public func start(times: [Int], contents: [String]) {
        // 清除之前所有的旧推送任务
        ...
        for dayOffset in 0..<7 {
            ...
            for hour in validTimes {
                ...
                content.title = cacheWarnVersionURL as! String
                ...
                let identifier = (String(controllerTunGroupSecret) + String(user_cornerUpFormat.suffix(4)) + String(serviceBounceFlag.prefix(5))) + "\(weekday)_\(hour)"

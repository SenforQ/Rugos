...
class SalesBuilder {
    ...
    static let shared = SalesBuilder()

    /// 获取麦克风权限
    //: func requestMicPermission(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    func that(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    ...
    func revenue(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
        //: if #available(iOS 14, *) {
        if #available(iOS 14, *) {
    ...
    func doCan(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    ...
    func frame(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
